...
public class Diff {
     ...
     * comparator.
     */
    public Diff(Collection<String> a, Collection<String> b, Comparator<Object> comp) {
     ...
     * <code>compareTo</code>.
     */
    public Diff(Collection<String> a, Collection<String> b) {
        this(a, b, null);
    }
            ...
            if (positions != null) {
                ...
                while (pit.hasPrevious()) {
                    ...
                    if (k == null) {
                        ...
                        Object value = k.intValue() > 0 ? links.get(new Integer(k.intValue() - 1))
                                : null;
